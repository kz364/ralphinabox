...
- Implemented local sandbox provider using local directories, subprocess execution, and git helpers.

## Next
- Implement Daytona sandbox behavior and GitHub/LiteLLM integrations.
